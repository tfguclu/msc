...
frames1 = traj[25010:45010]
#frames2 = traj[65010:85010]
...
saveModel(eda1,str(os.path.splitext(dcd)[0])+"_50_90")
#saveModel(eda2,str(os.path.splitext(dcd)[0])+"_130_170")

writeNMD(str(os.path.splitext(dcd)[0])+"_50_90", eda1, system)
#writeNMD(str(os.path.splitext(dcd)[0])+"_130_170", eda2, system)
...
savefig("cc_"+str(os.path.splitext(dcd)[0])+"_50_90", dpi=300, bbox_inches='tight')
...
# plt.imshow(cross_correlations), plt.colorbar()
# plt.axis([arange[0]+0.5, arange[-1]+1.5, arange[0]+0.5, arange[-1]+1.5])
# savefig("cc_"+str(os.path.splitext(dcd)[0])+"_130_170", dpi=300, bbox_inches='tight')
